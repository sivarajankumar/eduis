<?php
class Acad_Model_DbTable_SubjectMode extends Aceis_Base_Model {
	 ...
	 * @return Subject Mode
	 */
	public static function getActiveSubjectMode($subject_code, $groupMode = NULL) {
	...
	public static function getSubjectModes($subject_code, $groupMode = NULL)
	{
		$sql = self::getDefaultAdapter()
					 ->select()
					 ->from(self::TABLE_NAME,'subject_mode_id')
					 ->join('subject','( subject.subject_type_id = subject_mode.subject_type_id)',
					 array())
