<?php
class Acad_Model_Member_ProfileStatus extends Acad_Model_Generic
{
    ...
    /**
     * Sets Mapper
     * @param Acad_Model_Mapper_ProfileStatus $mapper
     * @return Acad_Model_Member_ProfileStatus
     */
    ...
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Acad_Model_Mapper_ProfileStatus());
        }
        return $this->_mapper;
    }
    /**
    ...
    public function activateProfile ()
    {
        ...
        $exists = $this->getMapper()->memberIdCheck($member_id);
        if ($exists) {
