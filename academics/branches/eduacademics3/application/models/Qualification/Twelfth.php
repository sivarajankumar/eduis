<?php
class Acad_Model_Qualification_Twelfth extends Acad_Model_Generic
{
    ...
    /**
     * Sets Mapper
     * @param Acad_Model_Mapper_Qualification_Twelfth $mapper
     * @return Acad_Model_Qualification_Twelfth
     */
    ...
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Acad_Model_Mapper_Qualification_Twelfth());
        }
        return $this->_mapper;
    }
    /**
    ...
    {}
    /**
     * Fetches Twelfth information of a Member
     *
     */
