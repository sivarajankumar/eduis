<?php
class Tnp_Model_Core_Batch extends Tnp_Model_Generic
{
    protected $_batch_id;
    ...
    /**
     * Sets Mapper
     * @param Tnp_Model_Mapper_Core_Batch $mapper
     * @return Tnp_Model_Core_Batch
     */
    ...
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Tnp_Model_Mapper_Core_Batch());
        }
        return $this->_mapper;
    }
    /**
