$(document).ready(function(){
	...
	var template = '<a id="{src}"'
		+ 'href="http://site.cdn.aceambala.com/plugins/photobooth/uploads/original/{src}" rel="cam" '
		+'style="background-image:url(http://site.cdn.aceambala.com/plugins/photobooth/uploads/thumbs/{src})"></a>';
	...
	webcam.set_swf_url('http://site.cdn.aceambala.com/plugins/photobooth/assets/webcam/webcam.swf');
	webcam.set_api_url('http://site.cdn.aceambala.com/plugins/photobooth/upload.php?rollno='+rollno);	// The upload script
	webcam.set_quality(100);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, 'http://site.cdn.aceambala.com/plugins/photobooth/assets/webcam/shutter.mp3');
