<?php
class Core_Model_Member_ProfileStatus extends Core_Model_Generic
{
    ...
    /**
     * Sets Mapper
     * @param Core_Model_Mapper_ProfileStatus $mapper
     * @return Core_Model_Member_ProfileStatus
     */
     ...
     * @return Core_Model_Mapper_ProfileStatus
     */
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Core_Model_Mapper_ProfileStatus());
        }
        return $this->_mapper;
    }
    /**
