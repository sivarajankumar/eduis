...
class StudentController extends Zend_Controller_Action
{
    ...
    public function getimagenameAction ()
    {
        ...
        //Zend_Registryget('logger')->debug($member_image);
        $format = $this->_getParam('format', 'log');
        switch ($format) {
            case 'html':
                break;
    ...
    public function collectexportabledataAction ()
    {
        ...
        switch ($format) {
            ...
            case 'json':
                ...
                break;
            case 'log':
                //Zend_Registryget('logger')->debug($data);
                break;
            default:
                ;
                break;
    ...
    public function saveclassinfoAction ()
    {
        ...
        switch ($format) {
            ...
            case 'json':
                ...
                break;
            case 'log':
                //Zend_Registryget('logger')->debug('No format was provided..');
                //Zend_Registryget('logger')->debug($student_class_info);
                break;
            default:
                ;
    ...
    public function fetchpersonalinfoAction ()
    {
        ...
        //Zend_Registryget('logger')->debug($personal_info);
    ...
    public function savepersonalinfoAction ()
    {
        ...
        switch ($format) {
            ...
            case 'json':
                ...
                break;
            case 'log':
                //Zend_Registryget('logger')->debug($member_id);
                break;
            default:
                ;
                break;
