<?php
class Lib_Model_DbTable_StudentDepartment extends Libz_Base_Model {
	 ...
	 */
    public static function getClassStudent($department, $degree, $semester, $group = NULL) {
        $sql = self::getDefaultAdapter ()
                        ->select ()
                        ->from(array ('batsem' => 'batch_semester' ),
                                array())
     ...
     */
    public static function getBatchStudent($department, $degree, $batch, $group = NULL) {
        $sql = self::getDefaultAdapter ()
                        ->select ()
