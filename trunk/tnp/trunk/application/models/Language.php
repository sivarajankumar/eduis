<?php
class Tnp_Model_Language extends Tnp_Model_Generic
{
    ...
    /**
     * Sets Mapper
     * @param Tnp_Model_Mapper_Language $mapper
     * @return Tnp_Model_Language
     */
    ...
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Tnp_Model_Mapper_Language());
        }
        return $this->_mapper;
    }
    /**
