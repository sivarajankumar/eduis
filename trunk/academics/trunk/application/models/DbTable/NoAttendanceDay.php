<?php
class Acad_Model_DbTable_NoAttendanceDay extends Aceis_Base_Model
{
	protected $_name = 'no_attendanceday';
	public static function isnoattendanceday($check_date,$department_id , $degree_id = NULL, $semester_id = NULL)
	{
		$sql = self::getDefaultAdapter()->select()
		              ->from('no_attendanceday', array('date_from','date_upto','purpose_id'))
