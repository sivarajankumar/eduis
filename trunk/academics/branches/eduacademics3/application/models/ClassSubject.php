<?php
class Acad_Model_ClassSubject extends Acad_Model_Generic
{
    protected $_class_id;
    ...
    /**
     * Sets Mapper
     * @param Acad_Model_Mapper_ClassSubject $mapper
     * @return Acad_Model_ClassSubject
     */
    ...
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Acad_Model_Mapper_ClassSubject());
        }
        return $this->_mapper;
    }
    /**
