<?php
class Acad_Model_Member_Member extends Acad_Model_Generic
{
    ...
    /**
     * Sets Mapper
     * @param Acad_Model_Mapper_Member_Member $mapper
     * @return Acad_Model_Member_Member
     */
     ...
     * @return Acad_Model_Mapper_Member_Member
     */
    public function getMapper ()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Acad_Model_Mapper_Member_Member());
        }
        return $this->_mapper;
    }
    /**
