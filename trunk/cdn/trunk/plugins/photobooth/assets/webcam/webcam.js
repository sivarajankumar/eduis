...
window.webcam = {
	...
	swf_url: 'http://site.cdn.aceambala.com/plugins/photobooth/assets/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://site.cdn.aceambala.com/plugins/photobooth/assets/webcam/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'http://site.cdn.aceambala.com/plugins/photobooth/assets/webcam/shutter.mp3';
	},
